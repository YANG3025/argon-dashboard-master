                  ...
                  <tbody class="text-secondary">
                    ...
                    <tr class="">
                      ...
                      <td class="align-middle pe-0">
                        ...
                        <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#staticBackdrop<?= $row["id"] ?>"><i class="fa-solid fa-eye fa-fw"></i></button>
                                  ...
                                  <div class="row">
                                    <div class="col-6 d-flex align-items-center justify-content-center">
                                      <div class="w-100 h-100 d-flex align-items-center justify-content-center square-container">
                                        <img style="width: 500px; min-width:250px;" class="object-fit-cover img-fluid"  src="../teachers_images/<?= $row["img"] ?>" alt="<?= $row["name"] ?>">
                                      </div>
                                    </div>
                                    <div class="col-6">
